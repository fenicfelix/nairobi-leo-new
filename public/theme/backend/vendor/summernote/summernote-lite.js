          ...
          ImageDialog_createClass(ImageDialog, [{
            ...
            value: function initialize() {
              ...
              var body = ['<div class="form-group note-form-group note-group-select-from-files">',
                // '<input type="button" class="btn btn-primary note-image-uploads" id="note-dialog-select-file-from-uploads-' + this.options.id + '" value="Select Image From Uploads"/>',
                '</div>', '<div class="form-group note-form-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label">' + this.lang.image.selectFromFiles + '</label>', '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input" ', ' type="file" name="files" accept="image/*" multiple="multiple"/>', imageLimitation, '</div>', '<div class="form-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + '</label>', '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control note-form-control note-input" placeholder="Paste image link" type="text"/>', '</div>'].join('');
            ...
            value: function showImageDialog() {
              ...
              return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
                var $imageUploads = _this2.$dialog.find('.note-image-uploads');
                ...
                _this2.ui.onDialogShown(_this2.$dialog, function () {
                  ...
                  $imageUploads.on('click', function (e) {
                    console.log("Display select image dialog");
                  });
        ...
        var VideoDialog_VideoDialog = /*#__PURE__*/function () {
          ...
          VideoDialog_createClass(VideoDialog, [{
            ...
            value: function createVideoNode(url) {
              // video url patterns(youtube, vimeo, dailymotion, youku, mp4, ogg, webm)
    ...
    /* text */ {
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
          ...
          options: {
            ...
            codeviewIframeWhitelistSrcBase: ['www.youtube.com', 'www.youtube-nocookie.com', 'www.facebook.com', 'vine.co', 'player.vimeo.com', 'www.dailymotion.com', 'player.youku.com', 'v.qq.com'],
            keyMap: {
              pc: {
                'ESC': 'escape',
